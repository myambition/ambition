...
func ReadOccurrencesByDate(ActionIDReadOccurrencesByDate int64, StartDateReadOccurrencesByDate string, EndDateReadOccurrencesByDate string) (*pb.OccurrencesByDateReq, error) {
	request := pb.OccurrencesByDateReq{
		ActionID:  ActionIDReadOccurrencesByDate,
		StartDate: StartDateReadOccurrencesByDate,
		EndDate:   EndDateReadOccurrencesByDate,
	}
	return &request, nil
}
